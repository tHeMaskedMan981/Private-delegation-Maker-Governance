...
contract DSChiefApprovals is DSThing {
    ...
    function setVerifer(address _verifierAddress) public {
    ...
    function vote(address[] memory yays, address delegator, uint[2] memory a,
            uint[2][2] memory b,
            uint[2] memory c,
            uint[3] memory input
    ...
    {   
        ...
        uint weight = deposits[delegator];
        subWeight(weight, votes[delegator]);
        votes[delegator] = slate;
        addWeight(weight, votes[delegator]);
    }
